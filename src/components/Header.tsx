    ...
    <header className="fixed inset-x-0 top-0 z-50 px-3 pt-3 sm:px-5 sm:pt-5">
      <div className="mx-auto flex max-w-[1720px] items-center justify-between rounded-[28px] border border-brand-red/10 bg-paper/95 px-4 py-2.5 shadow-[0_10px_30px_-12px_rgba(175,20,17,0.18)] backdrop-blur-md sm:px-6">
        <Link href="/" className="flex items-center gap-2" onClick={() => setOpen(false)}>
          <span className="grid h-9 w-9 place-items-center rounded-full bg-brand-red text-brand-cream shadow-sm">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
              <path
                d="M5 9h14l-1.2 9.2A2 2 0 0 1 15.8 20H8.2a2 2 0 0 1-2-1.8L5 9Z"
                stroke="currentColor"
                strokeWidth="2"
          ...
          <span className="font-display text-lg font-bold leading-none text-brand-red">
            Dabbawala
            <span className="block font-body text-[10px] font-medium tracking-[0.2em] text-ink/60">
              SINCE 1890 · PERTH
            </span>
          </span>
        </Link>
