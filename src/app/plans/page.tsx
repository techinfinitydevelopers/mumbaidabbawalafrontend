...
export default function PlansPage() {
  return (
    <div className="overflow-x-hidden">
      ...
      {/* ───── Closing CTA ───── */}
      <section className="grain graph-paper relative overflow-hidden bg-brand-cream pb-phi-5 pt-40 sm:pb-phi-6">
        ...
        <Reveal className="relative z-20 mx-auto max-w-3xl px-5 text-center sm:px-8">
          <p className="font-script text-3xl text-brand-orange">Still deciding?</p>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            ...
            <Button href="/whats-cooking-tomorrow" variant="paper" size="lg">
